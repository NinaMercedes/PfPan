...
def write_seq(file_name):
  ls_cmd = "ls *.fasta.gz > fasta_list.txt" #list all fasta files
  fm.run_cmd(ls_cmd)
  # writing to file
  newfile = open(file_name, 'w')
  # open fasta file and reformat into two columns 'strain' and 'path'
...
parser = argparse.ArgumentParser(description='Get seq file for cactus pangenome',formatter_class=argparse.ArgumentDefaultsHelpFormatter)
